...
class EmButton extends StatefulWidget {
  ...
  const EmButton({Key? key, required this.buttonName}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
        ...
        child: AnimatedContainer(
          ...
          child:  SizedBox(height: 85,width: 85,
            child: Center(child: Text(widget.buttonName!,style: TextStyle(fontSize: 18),)),
          ),
        ),
      );
    }
